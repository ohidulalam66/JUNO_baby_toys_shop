        ...
        <Row className="d-flex align-items-center">
          <Col xs={12} md={6}>
            <img
              ...
              src="https://i.postimg.cc/J4L1SdbH/x-f4fsnboom1-d-2.jpg"
              alt=""
            />
          </Col>
          <Col xs={12} md={6} className="discover-content">
            <animated.div style={styles}>
              ...
              <p>
                Fun, educational activities for every occasion with premium toys
                and snacks. Learn more about our services!
              </p>
            </animated.div>
            <Link to="/details">
              <Button variant="btn btn-outline-success" className="py-2 px-3">
                Discover Now
              </Button>
            </Link>
          </Col>
