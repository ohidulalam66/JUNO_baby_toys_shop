      ...
      <Container className="my-4">
        ...
        >
          ...
          <select className="form-select" id="inputGroupSelect01" ref={starRef}>
            <option className="text-success" value="5">
              Excellent(5-core)
            </option>
            <option className="text-success" value="4.5">
              (4.5-core)
            </option>
            <option className="text-success" value="4">
              Awesome(4-core)
            </option>
            <option className="text-success" value="3.5">
              (3.5-core)
            </option>
            <option className="text-success" value="3">
              Great(3-core)
            </option>
            <option className="text-success" value="2.5">
              (2.5-core)
            </option>
            <option className="text-success" value="2">
              Thank full(2-core)
            </option>
            <option className="text-success" value="1.5">
              (1.5-core)
            </option>
